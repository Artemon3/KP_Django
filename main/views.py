...
from main.forms import MailingForm, MessageForm, ClientForm, MailingModeratorForm
from main.models import Message, Mailing, Client, Logs
from main.services import get_cache_mailing_active, get_cache_mailing_count
...
class MailingUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def get_form_class(self):
        if self.request.user == self.get_object().owner:
            return MailingForm
        elif self.request.user.has_perm('main.set_is_activated'):
...
class MailingListView(LoginRequiredMixin, ListView):
    ...
    def get_queryset(self, *args, **kwargs):
        ...
        if self.request.user.has_perm('main.can_view'):
            return queryset
...
class ClientDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    ...
    def test_func(self):
        permissions = ('main.client_delete',)
        _user = self.request.user
